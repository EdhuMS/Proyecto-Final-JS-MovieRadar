    ...
    <footer className="mt-auto bg-gray-950 text-gray-400">
      <div className="container mx-auto px-4 pt-6 pb-3">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-10">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link to="/" className="hover:text-yellow-400 transition-colors">Series</Link></li>
              <li><Link to="/" className="hover:text-yellow-400 transition-colors">Tendencias</Link></li>
            </ul>
          </div>
        ...
        <div className="mt-6 pt-3 border-t border-gray-800 text-center">
          <p className="text-sm">
            © {new Date().getFullYear()} MovieRadar. Todos los derechos reservados.
          </p>
        </div>
      </div>
    </footer>
